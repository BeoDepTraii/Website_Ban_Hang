...
?>
        ...
        <script src="<?= APP_URL ?>/public/assets/client/css/lib/easing/easing.min.js"></script>
        <script src="<?= APP_URL ?>/public/assets/client/css/lib/waypoints/waypoints.min.js"></script>
        <script src="<?= APP_URL ?>/public/assets/client/css/lib/lightbox/js/lightbox.min.js"></script>
        <script src="<?= APP_URL ?>/public/assets/client/css/lib/owlcarousel/owl.carousel.min.js"></script>

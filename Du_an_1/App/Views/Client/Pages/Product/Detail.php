                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="border rounded">
                                    <a href="#">
                                        <img src="<?= APP_URL ?>/public/uploads/products/<?= $data['product']['image'] ?>" alt="Image" width="100%">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <h4 class="fw-bold mb-3"><?= $data['product']['name'] ?></h4>
                                <p class="mb-5">Category: Vegetables</p>
                                <?php
                                    if ($data['product']['discount_price'] > 0) :
                                    ?>
                                        <h6>Giá gốc: <strike><?= number_format($data['product']['price']) ?> đ</strike></h6>
                                    ...
                                    ?>
                                <p class="mb-5"><?= $data['product']['description'] ?></p>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="tab-content mb-5">
                                    ...
                                    <div class="tab-pane" id="nav-mission" role="tabpanel" aria-labelledby="nav-mission-tab">
                                        <div class="d-flex">
                                            <img src="<?= APP_URL ?>/public/uploads/users/user1.jpeg" class="img-fluid rounded-circle p-3" style="width: 100px; height: 100px;" alt="">
                                            <div class="">
